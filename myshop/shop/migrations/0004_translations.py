...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            #You have to manually change the bases from parler.models.TranslatedFieldsModelMixin to
            #parler.models.TranslatableModelMixin so as to avoid
            #"Translatable model <class '__fake__.Product'> does not appear to inherit from TranslatableModel" error
        ...
        migrations.CreateModel(
            ...
            #You have to manually change the bases from parler.models.TranslatedFieldsModelMixin to
            #parler.models.TranslatableModelMixin so as to avoid
            #"Translatable model <class '__fake__.Category'> does not appear to inherit from TranslatableModel" error
            bases=(parler.models.TranslatableModelMixin, models.Model),
        ),
    ]
